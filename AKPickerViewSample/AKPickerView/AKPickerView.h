...
typedef NS_ENUM(NSInteger, AKPickerViewOrientation) {
	AKPickerViewOrientationHorisontal = 1,
...
@property (nonatomic, assign) BOOL fasterDeceleration;
@property (nonatomic, assign) BOOL selectWhileScrolling;
